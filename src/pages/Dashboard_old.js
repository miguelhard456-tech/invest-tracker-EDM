  ...
  return (
    <div className="min-h-screen bg-background flex" data-testid="dashboard">
      ...
      >
        ...
        <nav className="flex-1 p-4 space-y-2">
          <Button
            ...
            data-testid="sidebar-calculator-btn"
          >
            <CalcIcon className="w-5 h-5" />
            {sidebarOpen && <span>{t('calculator')}</span>}
          </Button>
        </nav>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Header */}
        <header className="bg-card/60 backdrop-blur-xl border-b border-border px-6 py-4 flex items-center justify-between sticky top-0 z-10">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl font-heading font-bold">{t('investmentCalculator')}</h1>
          </div>
        ...
        <main className="flex-1 overflow-auto p-6">
          <div className="max-w-7xl mx-auto space-y-6">
            {/* Calculator Card */}
            <Card className="p-6" data-testid="calculator-card">
